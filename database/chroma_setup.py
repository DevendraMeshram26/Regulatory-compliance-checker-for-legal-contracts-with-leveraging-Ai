...
# top_k = 1  # Only get the most similar document
# results = collection.query(
#     query_texts=[query_text],
#     n_results=top_k
# )

# # Get the most similar contract and similarity score
# most_similar_document = results["documents"][0] if results["documents"] else None
# similarity_score = results["distances"][0] if results["distances"] else None

# # Check if similarity_score is a list and extract the first element
# if isinstance(similarity_score, list):
#     similarity_score = similarity_score[0]

# # Display the most similar contract and its similarity score
# if most_similar_document:
#     print("Most Similar Contract:")
#     print(f"Similarity Score: {similarity_score:.4f}")
#     print(f"Contract Details: {most_similar_document}")
# else:
#     print("No similar contract found.")
